<div>
    ...
    <div class="row">
        ...
        <div class="col-sm-7 offset-sm-0 text-left">
            <div class="form-group">
                <x-adminlte-input wire:model="firstName" name="iLabel" value="{{$profile->first_name}}" placeholder="please enter your first name"
                enable-feedback/>
    ...
    <div class="row">
        ...
        <div class="col-sm-7 offset-sm-0 text-left">
            <div class="form-group">
                <x-adminlte-input wire:model="lastName" name="iLabel" value="{{$profile->last_name}}" placeholder="please enter your last name"
                    disable-feedback/>
    ...
    <div class="row">
        ...
        <div class="col-sm-7 offset-sm-0 text-left">
            <div class="form-group">
                <x-adminlte-input wire:model="affiliation" name="iLabel" value="{{$profile->affiliation}}" placeholder="please enter your last name"
                    disable-feedback/>
    ...
    <div class="row">
        ...
        <div class="col-sm-5 offset-sm-0 text-left">
            <div class="form-group">
                <x-adminlte-input wire:model="email" value="{{$profile->email}}" name="iExtraAddress" >
